...
var FancyHeader = _styledComponents2.default.h1(_templateObject, function (_ref) {
  var primary = _ref.primary;
  return primary ? 'palevioletred' : 'royalblue';
});
...
var _unserializableParts = __webpack_require__(49);

var _unserializableParts2 = _interopRequireDefault(_unserializableParts);

var _linkedList = __webpack_require__(12);

var _linkedList2 = _interopRequireDefault(_linkedList);

var _moduleType = __webpack_require__(13);

var _moduleType2 = _interopRequireDefault(_moduleType);

var _PropsProxy = __webpack_require__(14);
...
var createProxyLinkedList = function createProxyLinkedList(userProxies) {
  return (0, _linkedList2.default)([].concat(_toConsumableArray(userProxies), [_PropsProxy2.default]));
};
...
var extractFixtureNames = function extractFixtureNames(fixtures) {
...
var getFixtureState = function getFixtureState(_ref) {
  var fixtures = _ref.fixtures,
      component = _ref.component,
      fixture = _ref.fixture,
      fixtureBody = _ref.fixtureBody,
...
var postMessageToParent = function postMessageToParent(data) {
  return parent.postMessage(data, '*');
};

var RemoteLoader = function (_Component) {
  _inherits(RemoteLoader, _Component);

  function RemoteLoader(props) {
    _classCallCheck(this, RemoteLoader);

    var _this = _possibleConstructorReturn(this, (RemoteLoader.__proto__ || Object.getPrototypeOf(RemoteLoader)).call(this, props));

    _this.state = noFixtureState;
    ...
    _this.onMessage = function (_ref2) {
      ...
      if (type === 'fixtureSelect') {
        _this.onFixtureSelect(data);
      } else if (type === 'fixtureEdit') {
        _this.onFixtureEdit(data);
      }
    };

    _this.onFixtureUpdate = function (fixtureBody) {
      var fixtures = _this.props.fixtures;
      var _this$state = _this.state,
          component = _this$state.component,
          fixture = _this$state.fixture,
          serializable = _this$state.fixtureBody.serializable,
          fixtureId = _this$state.fixtureId;


      _this.setState(getFixtureState({
        fixtures: fixtures,
        component: component,
        fixture: fixture,
        // Fixture updates are partial
        fixtureBody: _extends({}, serializable, fixtureBody),
  ...
  _createClass(RemoteLoader, [{
    ...
    value: function componentWillReceiveProps(_ref3) {
      ...
      if (!(0, _deepEqual2.default)(proxies, this.props.proxies)) {
        this.firstProxy = createProxyLinkedList(proxies);
      }

      // Keep parent frame in sync when fixture files are added to fs
      var fixtureNames = extractFixtureNames(fixtures);
      if (!(0, _deepEqual2.default)(fixtureNames, extractFixtureNames(this.props.fixtures))) {
        postMessageToParent({
      ...
      var isFixtureSelected = component && fixture;
      if (isFixtureSelected && fixtures[component][fixture] !== this.props.fixtures[component][fixture]) {
        this.setState(getFixtureState({
          ...
          if (isFixtureSelected) {
            ...
            _this2.onFixtureUpdate(_this2.state.fixtureBody.serializable);
          }
        });
      }
    }
    ...
    key: 'onFixtureSelect',
    value: function onFixtureSelect(_ref4) {
      var component = _ref4.component,
          fixture = _ref4.fixture;
      var fixtures = this.props.fixtures;

      var state = getFixtureState({
        fixtures: fixtures,
        component: component,
        fixture: fixture
      });
      ...
      if (fixture) {
        var fixtureBody = state.fixtureBody.serializable;
    ...
    key: 'onFixtureEdit',
    value: function onFixtureEdit(_ref5) {
      var fixtureBody = _ref5.fixtureBody;
      var fixtures = this.props.fixtures;
      var _state2 = this.state,
          component = _state2.component,
          fixture = _state2.fixture;
    ...
    value: function render() {
      ...
      var _state3 = this.state,
          ...
          fixtureBody = _state3.fixtureBody,
          fixtureId = _state3.fixtureId;
      ...
      var unserializable = fixtureBody.unserializable,
      ...
      return _react2.default.createElement(firstProxy.value, {
        ...
        fixture: (0, _lodash2.default)({}, unserializable, serializable),
...
RemoteLoader.propTypes = {
  components: (0, _propTypes.objectOf)((0, _moduleType2.default)(_propTypes.func)).isRequired,
  fixtures: (0, _propTypes.objectOf)((0, _propTypes.objectOf)((0, _moduleType2.default)(_propTypes.object))).isRequired,
...
var isComponentClass = function isComponentClass(componentType) {
  return (
...
var PropsProxy = function (_Component) {
  _inherits(PropsProxy, _Component);
  ...
  _createClass(PropsProxy, [{
    ...
    value: function render() {
      ...
      return isComponentClass(C) ? _react2.default.createElement(
        C,
        _extends({}, props, { ref: onComponentRef }),
        children
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_is_plain_object__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_stylis__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_function__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_hoist_non_react_statics__ = __webpack_require__(66);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2), __webpack_require__(61)))
...
var WrappedSection = function WrappedSection(_ref) {
  var text = _ref.text;
  return _react2.default.createElement(
    Wrapper,
    null,
...
var start = function start() {
  ...
  var getUserModules = __webpack_require__(57).default;
...
var _require2 = __webpack_require__(27),
    importComponent = _require2.default;

var normalizeComponents = exports.normalizeComponents = function normalizeComponents(components) {
  return Object.keys(components).reduce(function (acc, next) {
    return _extends({}, acc, _defineProperty({}, next, importComponent(components[next], next)));
  }, {});
};

var normalizeFixtures = exports.normalizeFixtures = function normalizeFixtures(fixtures) {
  return Object.keys(fixtures).reduce(function (acc, next) {
    var componentFixtures = fixtures[next];
    return _extends({}, acc, _defineProperty({}, next, Object.keys(componentFixtures).reduce(function (acc2, next2) {
      return _extends({}, acc2, _defineProperty({}, next2, importModule(componentFixtures[next2])));
    }, {})));
  }, {});
};
...
var _importModule = __webpack_require__(3);
...
exports.default = function (module, name) {
  var component = (0, _importModule2.default)(module, name);
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(8),p=__webpack_require__(9);__webpack_require__(10);var r=__webpack_require__(4);
...
var _mount = __webpack_require__(30);
...
var _RemoteLoader = __webpack_require__(11);

Object.defineProperty(exports, 'RemoteLoader', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_RemoteLoader).default;
  }
});
...
var _RemoteLoader2 = _interopRequireDefault(_RemoteLoader);

var _reactCosmosStateProxy = __webpack_require__(51);
...
function mount(_ref) {
  ...
  (0, _reactDom.render)(_react2.default.createElement(_RemoteLoader2.default, {
    components: components,
    fixtures: fixtures,
    proxies: [].concat(_toConsumableArray(proxies), [
...
*/
var aa=__webpack_require__(0);__webpack_require__(10);var l=__webpack_require__(33),n=__webpack_require__(8),ba=__webpack_require__(34),ca=__webpack_require__(4),da=__webpack_require__(9),ea=__webpack_require__(35),fa=__webpack_require__(36),ha=__webpack_require__(39),ia=__webpack_require__(40);
...
var _proxyPropTypes = __webpack_require__(52);
...
var _lodash5 = __webpack_require__(55);
...
function createStateProxy(options) {
  ...
  var StateProxy = function (_Component) {
    _inherits(StateProxy, _Component);
    ...
    function StateProxy() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StateProxy.__proto__ || Object.getPrototypeOf(StateProxy)).call.apply(_ref, [this].concat(args))), _this), _this.onComponentRef = function (componentRef) {
  ...
  StateProxy.propTypes = _extends({}, _proxyPropTypes2.default, {
...
Loader.propTypes = {
  component: (0, _moduleType2.default)(_propTypes.func).isRequired,
...
[__webpack_require__(58),__webpack_require__(59),__webpack_require__(60),__webpack_require__(67),__webpack_require__(68),__webpack_require__(69),__webpack_require__(70),__webpack_require__(71),__webpack_require__(72),__webpack_require__(73)];

var getUserModules = function getUserModules() {
  return {
    /* eslint-disable no-undef */
    components: {'button':__webpack_require__(6),'input':__webpack_require__(15),'title':__webpack_require__(7),'button-with-label':__webpack_require__(17),'wrapper':__webpack_require__(18)},
    fixtures: {'button':{'default':__webpack_require__(19)},'input':{'default':__webpack_require__(20)},'title':{'default':__webpack_require__(21)},'button-with-label':{'default':__webpack_require__(22)},'wrapper':{'default':__webpack_require__(23)}},
    proxies: []
